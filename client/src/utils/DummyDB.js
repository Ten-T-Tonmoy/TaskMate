export const chats = [
  {
    ...
    messages: [
      { 
        ...
        response: "To create a React component, you can use either a function or class. Here's a simple functional component:\n\n```jsx\nfunction MyComponent() {\n  return <div>Hello World!</div>;\n}\n```\n\nFunctional components are the modern preferred approach." 
      },
      { 
        user: "What about useState hook?", 
        response: "useState is a hook that lets you add state to functional components:\n\n```jsx\nimport { useState } from 'react';\n\nfunction Counter() {\n  const [count, setCount] = useState(0);\n  return (\n    <button onClick={() => setCount(count + 1)}>\n      Count: {count}\n    </button>\n  );\n}\n```" 
      },
    ],
  },
  {
